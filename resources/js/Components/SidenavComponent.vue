    ...
    <aside>
        <ul class="list-unstyled">
            <li class="list-group-item border-0 p-0" v-for="(item,key) in familias">
                <a href="" :data-target="'#categoria_'+key" data-toggle="collapse" aria-expanded="false" class="d-flex align-items-center p-2 border-bottom fwb700 " :class="familiaId == item.id ? 'bg-primario text-white' : 'text-color'">
